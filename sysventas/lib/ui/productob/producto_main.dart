...
class MainProductoB extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_)=>ProductoBloc(ProductoRepository(), UnidadMedidaRepository(),
            CategoriaRepository(), MarcaRepository())..add(ListarProductoEvent())),
...
class _ProductoUIState extends State<ProductoUI> {
      ...
      home: Scaffold(
        ...
        body: BlocBuilder<ProductoBloc, ProductoState>(builder: (context, state){
          if(state is ProductoLoadedState){
            ...
            return _buildListView(context, state.productoList);
          }else if(state is ProductoLoadedFilterState){
            lista=state.productoFiltroList!.isNotEmpty || state.productoFiltroList==[]?
            state.productoFiltroList: state.productoList;
  ...
  Widget _buildListView(BuildContext context, List<ProductoResp> producto) {
                ...
                child: TextFormField(
                  onChanged: (value){
                    ...
                    _timer=Timer(const Duration(milliseconds: 500), (){
                      context.read<ProductoBloc>().add(FilterProductoEvent(value));
                    });
                  },
                  ...
                  decoration: InputDecoration(
                    ...
                    suffixIcon: IconButton(
                        ...
                        onPressed: () {
                          _controller.clear();
                          context.read<ProductoBloc>().add(FilterProductoEvent(_controller.value.text));
                        }),
                ...
                child: Padding(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ProductoResp productox = producto[index];
                          return Padding(
                                                            ...
                                                            onPressed: () {
                                                              showDialog(
                                                                ...
                                                                if (value
                                                                    .toString() ==
                                                                    "Success") {
                                                                  print(productox.idProducto);

                                                                  //var onGoBack = onGoBack;
                                                                  BlocProvider.of<ProductoBloc>(context).add(DeleteProductoEvent(productox));
                                                                }
                                                              });
                                                            }))
                                                  ],
